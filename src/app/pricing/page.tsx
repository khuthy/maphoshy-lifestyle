...
const services = [
  {
    ...
    description: "For undecided clients — Portia guides you to the right service.",
    price: "R 350",
    note: "Video call or in-person",
    highlight: false,
  },
  {
    name: "Personal Style Consultation",
    description: "60–90 minute deep-dive into your style identity, colour palette and wardrobe goals.",
    price: "R 500",
    note: "In-person or virtual",
    highlight: true,
  },
  {
    name: "Wardrobe Curation & Editing",
    description: "Full wardrobe audit, edit and organisation with a shopping gap list.",
    price: "From R 800",
    note: "Duration varies by wardrobe size",
    highlight: false,
  },
  {
    name: "Personal Shopping",
    description: "Portia sources and presents curated options aligned to your style and budget.",
    price: "From R 600",
    note: "+ travel costs if applicable",
    highlight: false,
  },
  {
    name: "Corporate & Professional Styling",
    description: "Build a power wardrobe for your career and brand.",
    price: "From R 700",
    note: "Includes dress code analysis",
    highlight: false,
  },
  {
    name: "Event & Occasion Styling",
    description: "One-off look creation for weddings, graduations, galas and more.",
    price: "From R 650",
    note: "Custom garment add-on available",
    highlight: false,
  },
  {
    name: "Custom Garment Design",
    description: "Bespoke garments designed and made in-house from your measurements.",
    price: "From R 400",
    note: "Price excludes fabric cost",
    highlight: false,
  },
  {
    name: "In-House Alterations",
    description: "Expert alterations — hemming, taking in/letting out, zip replacement and more.",
    price: "From R 400",
    note: "Price depends on complexity",
    highlight: false,
  },
];
...
const faqs = [
  ...
  {
    question: "Can the consultation fee be deducted from my final service cost?",
    answer:
            ...
            {services.map((service) => (
              ...
              >
                ...
                <div className="flex items-center gap-4 shrink-0">
                  ...
                  <Link
                    href={`/book?service=${service.name.toLowerCase().replace(/[^a-z]+/g, "_")}`}
