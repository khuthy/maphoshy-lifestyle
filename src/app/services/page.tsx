...
const FALLBACK_SERVICES: ServiceRow[] = [
  { id: "1", service_key: "consultation", icon_name: "Sparkles", title: "Personal Style Consultation", description: "Your style journey starts here. In this deep-dive session, we get to know you — your lifestyle, personality, body shape, colour palette and goals. Together we'll define your signature style and build a clear roadmap to achieve it.", includes: ["60–90 minute style assessment", "Body shape and colour analysis", "Lifestyle and wardrobe audit", "Personalised style brief", "Shopping list and brand recommendations"], price_from: "R 500", booking_key: "consultation" },
